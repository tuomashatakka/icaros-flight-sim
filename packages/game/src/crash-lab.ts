...
import { loadShip } from 'Σassets/ship-loader'
import type { ShipInstance } from 'Σassets/ship-loader'
import {
  FORCE_COLOURS,
  FORCE_SCALE,
  MAX_ARROW,
...
import { CRASH_CASES, LANE_PITCH } from 'Φlab/cases'
import type { CrashCase, LabSolid, LabTrace } from 'Φlab/cases'
import { runCrashCase } from 'Φlab/run'
import { DEFAULT_CONFIGS } from 'Ȼship/registry'
import type { SunHandle } from 'Σmodules/sun'


type SunRef = { current: SunHandle | null }

import { environmentModules, resolveEnvironment } from 'Σenvironment'
