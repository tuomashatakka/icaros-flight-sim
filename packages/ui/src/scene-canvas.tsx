...
import { captureDeviceInfo, collectWebglReport, formatWebglReport } from 'Σwebgl-report'
import type { DeviceInfo, WebglReport } from 'Σwebgl-report'
import styles from './scene-canvas.module.css'
import { attachSceneLifecycle } from './scene-lifecycle'

import type { AnyApp } from 'Σtypes'
